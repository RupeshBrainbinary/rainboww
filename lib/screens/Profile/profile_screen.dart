...
import 'package:rainbow_new/screens/Profile/widget/other_visitors_viewed.dart';
import 'package:rainbow_new/screens/Profile/widget/postTestimonial_screen/post_testimonial_screen.dart';
import 'package:rainbow_new/screens/Profile/widget/profile_appbar.dart';
import 'package:rainbow_new/screens/Profile/widget/profile_details.dart';
import 'package:rainbow_new/screens/Profile/widget/profile_image.dart';
...
class ProfileScreen extends StatelessWidget {
  ...
  Widget profileImagesLoad(ProfileController controller, BuildContext context) {
    print(Get.height);
    return SizedBox(
      height: Get.height > 865 ? Get.height / 2.6 :  Get.height <645?Get.height/2.25:Get.height / 2.35,
      width: Get.width,
      child: Stack(
        children: [
          Padding(
