...
import 'package:rainbow_new/model/suggestion_model.dart';
import 'package:rainbow_new/screens/Home/settings/connections/api/connections_api.dart';
...
class ConnectionsController extends GetxController {
  ...
  void onTapViewProfile(String userId) {
    ...
    Get.to(() => ConnectionsProfileScreen(show2 : false,))?.then((value) {
      if (kDebugMode) {
