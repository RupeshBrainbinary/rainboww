...
import 'package:rainbow_new/screens/Home/settings/subscription/subscription_controller.dart';
import 'package:rainbow_new/screens/Home/settings/subscription/subscription_payment/subscription_payment_screen.dart';
...
class SubscriptionScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    controller.subscriptionDataApi();
    return Scaffold(
      body: Stack(
        children: [
          SafeArea(
                          ...
                          SizedBox(
                              ...
                              child: PageView.builder(
                                ...
                                itemBuilder: (context, index) =>
                                     GetBuilder<SubscriptionController>(id: "Sub",
                                       builder: (controller) {
                                      return  Padding(
                                        padding: EdgeInsets.only(left: Get.width * 0.05866),
                                        child: controller.subscriptionModel.data==null?const SizedBox():Column(
                                              ...
                                              builder: (controller) {
                                                return   RichText(
                                                  text: TextSpan(children: [
                                                    TextSpan(
                                                      text: "£${controller.subscriptionModel.data!.amount.toString()??""}",
          ...
          Obx(() => controller.loader.isTrue?FullScreenLoader():const SizedBox())
