...
import 'package:rainbow_new/screens/Home/story_commets/widget/story_comment.dart';
                                ...
                                itemBuilder: (context, index) {
                                  return storyComment(
                                      comments: controller
                                          ...
                                          .toString(),
                                      profileImage: controller.comments[index]
                                          .storyUserComment!.profileImage
                                          .toString(),
                                      name: controller.comments[index]
                                          .storyUserComment!.fullName
                                          .toString(),
                                      id: controller
                                          .comments[index].storyUserComment!.id
                                          .toString(),
                                      connectionsProfileController:
                                          connectionsProfileController);
                                },
                          ...
                          InkWell(
                            onTap: () {
                              controller.commentSendTap(
                                  controller.currentStoryId.toString(),
                                  context);
                            },
                            child: Image.asset(
                              AssetRes.send,
