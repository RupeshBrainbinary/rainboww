...
import 'package:rainbow_new/screens/advertisement/ad_home/screen/edit_advertisement/edit_advertisement_controller.dart';
import 'package:rainbow_new/screens/advertisement/ad_home/screen/edit_advertisement/edit_advertisement_screen.dart';
import 'package:rainbow_new/screens/advertisement/ad_home/widget/advertisementApproved_screen.dart';
import 'package:rainbow_new/screens/advertisement/ad_home/widget/advertisermentRejected_Screen.dart';
import 'package:rainbow_new/screens/advertisement/ad_home/widget/charrr.dart';
...
class AdvertisementDetailsApprovedScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    SystemChrome.setSystemUIOverlayStyle(
        SystemUiOverlayStyle(statusBarColor: Color(0xff50369C)));
    return Scaffold(
      body: Obx(
        () {
          return Stack(
        ...
        GetBuilder<CreateAdvertisementController>(
            ...
            builder: (controller) {
              return SizedBox(
                ...
                child: Stack(
                  children: [
                    (adHomeController.myAdList[index].itemsList!.length == 0)
                        ? Image.asset(
                        ...
                        : PageView.builder(
                            ...
                            itemCount: adHomeController
                                .myAdList[index].itemsList!.length,
                            onPageChanged: (index) {
                            ...
                            itemBuilder: (context, index1) {
                              return SizedBox(
                                ...
                                child: FadeInImage(
                                  ...
                                  image: NetworkImage(
                                    adHomeController
                                        .myAdList[index].itemsList![index1]
                                        .toString(),
                                  ),
                                  width: Get.width - 60,
                                  fit: BoxFit.cover,
                    ...
                    Column(
                      children: [
                        ...
                        (adHomeController.myAdList[index].itemsList!.length ==
                                    1 ||
                                adHomeController
                                        .myAdList[index].itemsList!.length ==
                                    0)
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            children: [
              Text(
                adHomeController.myAdList[index].title.toString(),
                style: gilroySemiBoldTextStyle(
                  fontSize: 18,
                ),
              ),
              const Spacer(),
              (adHomeController.myAdList[index].adminStatus.toString() ==
                      'approve')
                  ? InkWell(
                      onTap: () {
                  ...
                  : (adHomeController.myAdList[index].adminStatus.toString() ==
                      ...
                      : InkWell(
                          onTap: () {
                            Get.to(() => AdvertisermentRejectedScreen(
                                  traId: traId,
                                ));
                          },
                          child: Text(
          ...
          Text(
            "£${adHomeController.myAdList[index].amount ?? ""}",
            style: gilroySemiBoldTextStyle(
              fontSize: 18,
            ),
          ),
          ...
          ReadMoreText(
            adHomeController.myAdList[index].description.toString(),
            trimLines: 3,
            ...
            children: [
              ...
              SizedBox(
                ...
                child: ListView.builder(
                  scrollDirection: Axis.horizontal,
                  shrinkWrap: true,
                  itemCount: adHomeController.myAdList[index].tagsList!.length,
                  itemBuilder: (context, index1) => Padding(
                    padding: const EdgeInsets.symmetric(horizontal: 8.0),
                    child: adHomeController.myAdList[index].tagsList![index1] ==
                            " "
                        ? const SizedBox()
                        : Container(
                            height: 25,
                                ...
                                child: SingleChildScrollView(
                                  ...
                                  child: Row(
                                    children: [
                                      Text(
                                        adHomeController
                                            .myAdList[index].tagsList![index1]
                                            .toString(),
          ...
          Text(
            adHomeController.myAdList[index].callAction.toString(),
          ...
          InkWell(
            ...
            child: Text(
              adHomeController.myAdList[index].urlLink.toString(),
              style: gilroyRegularTextStyle(fontSize: 14),
            ),
          ),
